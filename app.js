...
const demandedMoviesRoutes = require('./API/routes/movies/onDemandedMovies/onDemandedMovies');
const movieUploadRoute = require('./API/routes/movie-upload/movie-upload');
const searchMovieController = require('./API/routes/movies/search-movie/search-movie');
const feedbackRoute = require('./API/routes/Feedback/Feedback')
...
app.use('/api/admin/uploads', movieUploadRoute);
app.use('/api/users', feedbackRoute);
app.use('/api/', searchMovieController)
